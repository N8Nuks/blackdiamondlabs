      ...
      <footer className="border-t border-white/5 px-12 py-6 bg-black">
        <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://billing.stripe.com/p/login/4gM28q9uOeIe0BMb71ak000" className="text-xs text-white/30 hover:text-white transition-colors">Manage subscription</a>
