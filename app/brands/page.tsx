...
export default function Brands() {
  const brands = [
    ...
    { name: 'LegacyMint', tagline: 'Your Legacy. Their Dream.', taglineColor: '#FFD700', desc: 'NFT fundraising platform — creating and sharing lasting digital legacies, stories, moments, and memories built to endure.', status: 'In Development', href: '#', accent: '#2596be' },
    { name: 'FutureProof Solutions', tagline: 'Built for what comes next.', taglineColor: '#C0C0C0', desc: "Diversification Education. In a fast changing environment, are you ready for what's next?", status: 'In Development', href: '#', accent: '#FFD700' , blur: true , blur: true },
    ...
    { name: 'Black Diamond AI', tagline: 'Your AI. Trained on sport.', taglineColor: '#E8C77A', desc: 'Coach Nate — an AI coaching assistant built on two decades at the top of the game. Game plans, training, in-game calls, the mental side. Live now for Founding Members.', status: 'Live', href: '/coach-nate', accent: '#E8C77A' },
