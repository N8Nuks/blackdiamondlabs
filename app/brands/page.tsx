...
export default function Brands() {
  const brands = [
    ...
    { name: 'Black Diamond Performance', tagline: 'Elite experience. Personalised feedback.', taglineColor: '#C7CEDA', desc: 'Expert video analysis and live one-on-one Performance Review Consultations. Registrations open — first 5 registrations: 2 selected for a FREE first session.', status: 'Live', href: '/performance', accent: '#C7CEDA' },
