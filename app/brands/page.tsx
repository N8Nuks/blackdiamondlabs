...
export default function Brands() {
  const brands = [
    { name: 'Grassroots Fantasy', tagline: 'Built for the game you love.', taglineColor: '#2d9e4e', desc: 'Fantasy league platform for the Northern Fastpitch Series — collect player cards, build your squad, score points based on real game results.', status: 'Live', href: 'https://grassrootsfantasy.co.nz', accent: '#2d9e4e' },
