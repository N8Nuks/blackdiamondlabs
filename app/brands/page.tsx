...
export default function Brands() {
  const brands = [
    ...
    { name: 'Black Diamond AI', tagline: 'Your AI. Trained on sport.', taglineColor: '#E8C77A', desc: 'Coach Nate — an AI coaching assistant built on two decades at the top of the game. Game plans, training, in-game calls, the mental side. Live now for Founding Members.', status: 'Live', href: '/bd-ai', accent: '#E8C77A' },
