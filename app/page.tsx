        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          <div className="relative z-10 w-full lg:w-1/2 px-6 sm:px-10 lg:px-16 pt-28 pb-16 lg:pt-0 lg:pb-0 flex flex-col justify-center">
            ...
            <h1 className="opacity-0 animate-fade-up delay-1 font-black leading-none mb-0"
              ...
              Black<br />D<span style={{ position: 'relative', display: 'inline-block' }}>ı<span style={{ position: 'absolute', left: '50%', top: '-0.58em', transform: 'translateX(-50%)', width: '0.4em', height: '0.42em', pointerEvents: 'none' }}><svg viewBox="0 0 520 540" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="185,72 335,72 345,165 260,180 175,165" fill="url(#gTable)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="185,72 98,150 175,165" fill="url(#gBezelL)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="98,150 30,238 148,238 175,165" fill="url(#gCrownL)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="175,165 148,238 260,238 260,180" fill="url(#gMidL)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="335,72 422,150 345,165" fill="url(#gBezelR)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="422,150 490,238 372,238 345,165" fill="url(#gCrownR)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="345,165 372,238 260,238 260,180" fill="url(#gMidR)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="30,238 148,238 260,502" fill="url(#gPavOutL)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="148,238 260,238 260,502" fill="url(#gPavInL)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="260,238 372,238 260,502" fill="url(#gPavInR)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><polygon points="372,238 490,238 260,502" fill="url(#gPavOutR)" stroke="#E8C77A" strokeWidth="2" strokeOpacity="0.6"/><path d="M185,72 L335,72 L422,150 L490,238 L260,502 L30,238 L98,150 Z" fill="none" stroke="#FFD700" strokeWidth="3" strokeOpacity="0.85"/><circle cx="260" cy="500" r="22" fill="url(#culetGlow)"/></svg></span></span>amond<br />Labs<span style={{ color: '#00CFFF' }}>.</span>
            </h1>
