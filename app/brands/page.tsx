...
export default function Brands() {
  const brands = [
    ...
    { name: 'FutureProof Solutions', tagline: 'Built for what comes next.', taglineColor: '#C0C0C0', desc: "Diversification Education. In a fast changing environment, are you ready for what's next?", status: 'In Development', href: '#', accent: '#FFD700' },
